...
CSV_PATH = ROOT / "data" / "r04_kanteihyoka.csv"
SOURCE_PATH = ROOT / "scripts" / "r04_q41_80_source.txt"
PDF_PATH = ROOT / "raw_data" / "2022" / "kantei_question.pdf"
BUNDLE_GZ_PATH = ROOT / "dist" / "bundles" / "r04.jsonl.gz"
...
def parse_block(block_text: str, exam: str) -> dict[str, str]:
    ...
    if exam != "combo_iroha" and len(choices) > 5:
        choices = choices[-5:]
